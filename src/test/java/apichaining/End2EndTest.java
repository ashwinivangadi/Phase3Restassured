...
public class End2EndTest {
	Response response;
	String BaseURI = "http://54.226.172.89:8088/employees";
	...
	public void test1() {
		...
		response = PostMethod("Ashwini", "Angadi", "2000", "lucy@123mail.com"); 
...
//		 List<String> names=jpath.get("id");  // print all id
		...
		response = PutMethod(empid, "Madhu", "Test"); 
		Assert.assertEquals(response.getStatusCode(), 200);
       jpath = response.jsonPath();
      Assert.assertEquals(jpath.get("firstName"), "Madhu");
